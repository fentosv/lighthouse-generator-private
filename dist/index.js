...
module.exports = eval("require")("./getLighthouseReport");
...
/* harmony import */ var _getLighthouseReport__WEBPACK_IMPORTED_MODULE_1__ = __nccwpck_require__(463);



async function run() {
  try {
    const badgeStyle = _actions_core__WEBPACK_IMPORTED_MODULE_0__.getInput('badgeStyle')
    const commitAuthor = _actions_core__WEBPACK_IMPORTED_MODULE_0__.getInput('commitAuthor')
    const commitMessage = _actions_core__WEBPACK_IMPORTED_MODULE_0__.getInput('commitMessage')
    const mdName = _actions_core__WEBPACK_IMPORTED_MODULE_0__.getInput('mdName')
    ...
    _getLighthouseReport__WEBPACK_IMPORTED_MODULE_1__({ url, badgeStyle, mdName })
